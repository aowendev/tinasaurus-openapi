...
La commande `npm run start` construit votre site web localement et le sert à travers un serveur de développement, prêt à être visualisé sur [http://localhost:3000/](http://localhost:3000/).

Ouvrez `docs/intro.md` (cette page) et éditez quelques lignes : le site **se recharge automatiquement** et affiche vos changements.
