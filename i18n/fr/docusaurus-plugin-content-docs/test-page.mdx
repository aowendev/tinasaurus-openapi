...
Inline variable (<VariableSet setKey="writing-terms" variableKey="single-sourcing" />) can be added in the rich text editor.

### Glossary terms

Glossary terms such as <GlossaryTerm termKey="single-sourcing" /> can also be added.
